...
| `docker-compose.yml` | ★ servicios `sqlserver` (2022, :11446, healthcheck) + `sqlserver-init` + variables `Motor` y `ConnectionStrings__SqlServer` en la API |
...
- Puerto publicado **11446** (curso; la reconstrucción del estudiante
  usa 11546).
