...
└── api_facturas/
    ...
    ├── Dockerfile                    # sdk:10.0 + dotnet watch (puerto 8046)
    ├── Modelos/
...
funcionando. En v1 eso son **dos servicios**: `postgres` (15446 al host,
se siembra solo) y `api-facturas` (8046, código montado +
