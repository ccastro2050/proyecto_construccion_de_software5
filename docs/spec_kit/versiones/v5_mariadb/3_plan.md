...
| `docker-compose.yml` | ★ servicio `mariadb` (11, :13346, se siembra solo) + `ConnectionStrings__MariaDb` |
...
- Puertos publicados: 8046 (API) · 15446 (postgres) · 11446 (sqlserver)
  · **13346 (mariadb)**. Reconstrucción del estudiante: +100 (13446).
