...
flowchart LR
    ...
    NAV -.->|"opcional (diagnóstico):<br/>localhost:15446"| POSTGRES
    NAV -.->|"opcional (diagnóstico):<br/>localhost:11446"| SQLSERVER
    NAV -.->|"opcional (diagnóstico):<br/>localhost:13346"| MARIADB
```
